...
class Foreign_Cigarette_Category(models.Model) :
...
class Foreign_Cigarette(models.Model) :
  Category = models.CharField(max_length=100)
  ...
  def get_absolute_url(self) :
    return reverse('Foreign_Cigarette_App:RCD', args=[self.Name])
...
class Foreign_Cigarette_Comment(models.Model) :
  Object = models.ForeignKey(Foreign_Cigarette, on_delete=models.CASCADE, related_name='Comments')
  Nickname = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='F_Nickname')
